...
## Potential Impact
Identifying which groups are most vulnerable to cybersecurity risks (and how they respond to them) has
meaningful implications for public policy and digital inclusion efforts. Insights from this study can inform
targeted educational programs, resource allocation, and support strategies designed to reduce unequal exposure
to cyber harm. Therefore, understanding patterns of protection, incident experience and trust can
guide initiatives aimed at strengthening digital resilience and building a more equitable and trustworthy
digital environment in Canada.
...
kable(tt_compare, digits = 4,caption = "Train-Test 80/20") 
...
kable(cv_summary, digits = 4, caption = "10-Fold Cross Validation for Models 1-7") 
...
The analysis of the 2022 Canadian Internet Use Survey reveals systematic differences in cybersecurity behaviours, incident exposure, and digital trust across the Canadian population in the post-pandemic period. Education emerges as the most robust determinant of cybersecurity practices across all behavioural domains, suggesting that formal attainment shapes digital literacy, confidence, and familiarity with security tools. Trust, by contrast, is less demographically patterned and more strongly shaped by experiential and attitudinal factors: individuals with higher life satisfaction report higher trust, whereas those who have experienced cyber incidents express lower confidence in digital systems. Model 7 further demonstrates that protective behaviours do not relate to trust uniformly—ID-security practices are associated with higher trust, while extensive data-protection behaviours predict lower trust. Age remains a persistent axis of vulnerability, with older adults engaging less in protective practices. Meanwhile, disabled and Indigenous respondents show heightened post-incident responsiveness, challenging deficit narratives and signalling more complex dynamics of vigilance and risk. These findings must also be read alongside the limits of the CIUS, whose shifting survey design precluded longitudinal comparisons and required the construction of proportion-based behavioural scores that compress nuance. Together, these factors underscore the need for greater instrument stability and more refined demographic measures in future survey cycles.

These patterns carry clear implications for public policy and digital inclusion efforts. Strengthening digital resilience in Canada will require scalable cybersecurity education initiatives targeted toward populations with lower levels of formal education, alongside age-responsive programming that supports older adults who remain disproportionately vulnerable. Efforts to reinforce digital trust must account for the emotional and experiential dimensions of risk, including the role of transparent data handling and clear communication in shaping user perceptions. Furthermore, the elevated post-incident engagement observed among several equity-seeking groups highlights the importance of designing interventions and supports that acknowledge diverse experiences of vulnerability rather than assuming uniform disengagement.

In direct response to the research questions, the findings show that cyber incidents in 2022 were most often experienced or noticed by individuals with higher education, lower life satisfaction, and members of certain demographic groups such as disabled and Indigenous respondents. Canadians’ feelings about cybersecurity and digital trust were strongly shaped by lived experience: those with higher life satisfaction and strong ID-security habits expressed greater trust, while those with more incident exposure or extensive data-protection behaviours expressed less. Overall, the study illustrates a post-pandemic digital landscape in which exposure, trust, and protective responses are unevenly distributed, shaped by both behavioural patterns and lived experience.
